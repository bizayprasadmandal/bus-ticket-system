...
export default function DriverLayout() {
  ...
  const getBreadcrumbs = () => {
    ...
    const crumbs = [{ label: 'Home', path: '/driver' }];
    let currentPath = '';
        ...
        <div className="p-4 border-t">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-gray-800 truncate">{user?.full_name || 'Driver'}</p>
      ...
      <div className="flex-1 flex flex-col min-w-0 animate-fade-in">
        ...
        <div className="bg-white border-b">
          <div className="lg:hidden h-14 flex items-center px-4">
            ...
            <h1 className="ml-3 text-lg font-bold text-emerald-600">Driver Panel</h1>
          </div>
                ...
                {breadcrumbs.map((crumb, i) => (
                  <span key={crumb.path} className="flex items-center gap-1">
                    ...
                    {i === breadcrumbs.length - 1 ? (
                      ...
                      <Link to={crumb.path} className="hover:text-emerald-600 transition-colors">{crumb.label}</Link>
                    )}
                  </span>
                ))}
              </nav>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3 pl-4 border-l border-gray-200">
                ...
                <div className="text-right">
                  <p className="text-sm font-medium text-gray-800">{user?.full_name || 'Driver'}</p>
